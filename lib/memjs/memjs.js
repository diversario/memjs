...
Client.prototype.set = function(key, value, expires, callback) {
...
//
//     callback(err, success)
Client.prototype.add = function(key, value, expires, callback) {
  if (typeof expires == 'function') {
    callback = expires
    expires = null
  }
...
//
//     callback(err, success)
Client.prototype.replace = function(key, value, expires, callback) {
  if (typeof expires == 'function') {
    callback = expires
    expires = null
  }
...
Client.prototype.increment = function(key, amount, expires, callback) {
  if (typeof expires == 'function') {
    callback = expires
    expires = null
  }
...
//
//     callback(err, success)
Client.prototype.decrement = function(key, amount, expires, callback) {
  if (typeof expires == 'function') {
    callback = expires
    expires = null
  }
